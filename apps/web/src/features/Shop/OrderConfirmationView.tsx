  ...
  const statusConfig = {
    ...
    processing: {
      ...
      description: isExtendedProcessing
        ? i18n(
            "Your payment is still being verified. This can take a few minutes. I'll send you a confirmation email once your order is confirmed - no need to wait on this page.",
          )
        : i18n("Your payment is being processed. I'll send you a confirmation email once complete."),
      icon: Clock,
    ...
    succeeded: {
      color: "text-success",
      description: i18n("Your order has been confirmed! I'll send you an email with the details."),
      icon: CheckCircle,
