...
export const Glossary = () => {
  ...
  return (
    <ul className={`text-neutral list-inside list-disc space-y-4 md:space-y-2`}>
      <li>
        <span className="text-on-surface font-semibold">{i18n("PCC — Podatek od czynności cywilnoprawnych (Civil-Law Transactions Tax)")}</span> -{" "}
        {i18n(
      ...
      <li>
        <span className="text-on-surface font-semibold">{i18n("Rynek pierwotny / Rynek wtórny (Primary / Secondary market)")}</span> -{" "}
        {i18n(
      ...
      <li>
        <span className="text-on-surface font-semibold">{i18n("Wkład własny (Down payment / Equity contribution)")}</span> -{" "}
        {i18n(
      ...
      <li>
        <span className="text-on-surface font-semibold">{i18n("Stałe / Zmienne oprocentowanie (Fixed / Variable rate)")}</span> -{" "}
        {i18n(
