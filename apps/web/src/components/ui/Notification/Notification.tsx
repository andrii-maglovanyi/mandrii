...
export const Notification = memo(function Snackbar({
  ...
  return (
    open && (
      <div
        className={`bg-on-surface text-surface pointer-events-auto fixed right-0 bottom-4 left-0 z-50 mx-auto flex w-min max-w-[90%] min-w-96 transform items-center justify-between rounded-lg p-4 transition-transform`}
        style={{
