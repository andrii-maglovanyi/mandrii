...
import { MESSAGING_UNREAD_UPDATED_EVENT, UnreadMessagingUpdate } from "~/hooks/useUnreadMessages";
...
export const MessageToast = () => {
  ...
  const [message, setMessage] = useState<UnreadMessagingUpdate["latest"]>(null);
