...
export default function LovePage() {
  ...
  return (
    <div className={`mx-auto flex flex-grow flex-col items-center justify-center space-y-6 text-center`}>
      <div className={`border-b border-b-black dark:border-b-neutral-700`}>
        <Avatar />
      </div>
      <h1
        className={`from-primary to-secondary w-fit bg-gradient-to-r bg-clip-text text-4xl font-bold text-transparent`}
      >
      ...
      <div>
        <Image alt="Mandrii" className={`mt-2 h-auto dark:invert`} height={44} src="/static/logo.svg" width={120} />
