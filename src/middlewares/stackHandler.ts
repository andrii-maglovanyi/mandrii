...
export type MiddlewareHandler = (request: NextRequest, event: NextFetchEvent) => NextResponse | Promise<NextResponse>;

export function stackMiddlewares(middlewareFactories: MiddlewareFactory[]): MiddlewareHandler {
